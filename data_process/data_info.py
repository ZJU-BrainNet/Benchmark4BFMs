...
data_info_dict = {
    ...
    'BCI-2a': {'data_path': '.../benchmark/datasets/BCICIV_2a/group_data',
        'group_num': 4,
        'split': [2, 1, 1],
        'various_ch_num': False,
        'n_class': 4,
    ...
    'Chisco_read': {'data_path': '.../benchmark/datasets/Chisco/group_data_read',
        'group_num': 5,
        'split': [3, 1, 1],
        'various_ch_num': False,
        'n_class': 39,
        ...
        'seq_len': 3.3,
        'downstream': 'Concept',
        'label_path': '.../benchmark/datasets/Chisco/classnumber.json',
    },
    'Chisco_imagine': {'data_path': '.../benchmark/datasets/Chisco/group_data_imagine',
        'group_num': 5,
        'split': [3, 1, 1],
        'various_ch_num': False,
        'n_class': 39,
